    ...
    <el-container>
      ...
      <el-main>
        ...
        <el-form ref="ruleFormRef" :model="form" label-width="120px" :rules="rules">
          ...
          <el-form-item label="支付密码密码:" prop="userPayPwd">
            <el-input class="nav" v-model="form.userPayPwd" placeholder="请输入支付密码"/>
            <span>请填写密码</span>
          </el-form-item>
        ...
        <div class="box1">
          <div class="shang">
            ...
            <a class="asd" href="#" @click="handleOperation">操作手册</a><a @click="handleProblem" class="asd"
                                                                        href="#">常见问题</a><a class="asd" href="#"
                                                                                            @click="handleSafety">安全手册</a>
          </div>
